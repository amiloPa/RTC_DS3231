...
StdPeriph_Driver/src/%.o: ../StdPeriph_Driver/src/%.c
	...
	@echo $(PWD)
	arm-none-eabi-gcc -mcpu=cortex-m3 -mthumb -mfloat-abi=soft -DSTM32 -DSTM32F1 -DSTM32F101C8Tx -DSTM32F10X_MD -DUSE_STDPERIPH_DRIVER -I"E:/STM32_ARM/MY_LIBRARIES/StdPeriferial_I2C_and_DS3231/StdPeriph_Driver/inc" -I"E:/STM32_ARM/MY_LIBRARIES/StdPeriferial_I2C_and_DS3231/inc" -I"E:/STM32_ARM/MY_LIBRARIES/StdPeriferial_I2C_and_DS3231/CMSIS/device" -I"E:/STM32_ARM/MY_LIBRARIES/StdPeriferial_I2C_and_DS3231/CMSIS/core" -O3 -Wall -fmessage-length=0 -ffunction-sections -c -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
